...
Gravitational waves propagate along null geodiscs and are therefore subject to gravitatioanl lensing in the sam manner as electromagnetic radiation in the geometric optics limit [1-4]. 
...
To leasing order, the images share the same intrinsic binary paramters while differing in arrival time, amplitude through the lensing magnification, and an image type dependent phase contribution [5-8].
...
%sams part
Consider two GW detections, $d_GW={d_{GW,1},d_{GW,2}}$, together with EM observations dEM drawin from a catalogue of potential foreground lenses. 
...
This distinction is important because prior odds and search selection can change substantially as the GW catalogue grows [10,12,18].
