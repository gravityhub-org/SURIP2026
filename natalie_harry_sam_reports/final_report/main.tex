...
\subsection{Parameterisation and Conditional Structure}
...
\subsubsection{Lens and Source Plane Parameters}
...
\subsection{Unlensed Hypothesis}
%sam
...
\sub:xsection{$H_1$: catalogued lens wit resolved strong lensing information}
%sam
