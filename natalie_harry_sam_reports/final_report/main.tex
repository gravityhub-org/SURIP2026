...
To leasing order, the images share the same intrinsic binary paramters while differing in arrival time, amplitude through the lensing magnification, and an image type dependent phase contribution \cite{3},\cite{4},\cite{5},3-6. 
...
Early work proposed posterior overlap statistics for lensed GW indentification \cite{3}, while subsequent analyses incorporated lensing time-delay distributions, astrophysical populations, selections effects and full join parameter estimation [7-10].
